    ...
    <div className="bg-background-dark text-slate-100 font-display min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <header className="px-8 py-6 border-b border-neutral-border bg-background-dark/50 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-black text-white">Extracurricular Management</h1>
              ...
              {sports.map((sport) => (
                <div key={sport.id} className="bg-neutral-dark/30 rounded-2xl border border-neutral-border p-6 hover:border-primary/50 transition relative group flex flex-col">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="px-3 py-1 bg-emerald-500/10 text-emerald-400 text-[10px] font-black uppercase tracking-widest rounded-full border border-emerald-500/20">Active Hub</span>
                  </div>
                  ...
                  <div className="space-y-2 mt-auto pt-4 border-t border-white/5">
                    ...
                    {sport.whatsappLink ? (
                      <a 
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-sm font-bold text-emerald-400 hover:bg-emerald-500/20 transition mt-2"
                      >
                        <Users size={14} />
                        <span>Join WhatsApp Group</span>
                      </a>
                    ) : (
                      <div className="w-full py-2 bg-neutral-dark/50 border border-neutral-border rounded-xl text-xs text-center text-slate-500 italic">
