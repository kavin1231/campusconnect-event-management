              ...
              <div className="sd-study-support-container">
                <div className="sd-study-support-content">
                  <div className="sd-study-support-header">
                    ...
                    <p>
                      Access curated study materials, PDFs, and join scheduled
                  ...
                  <div className="sd-study-features">
                    <div className="sd-study-feature-card">
                      ...
                      <p>
                        Access organized study PDFs, notes, and resources
                        tailored for your semester
                      </p>
                    </div>
                    ...
                    <div className="sd-study-feature-card">
                      ...
                      <p>
                        Find curated external resources, tutorials, and
                        reference materials
                      </p>
                    </div>
                    ...
                    <div className="sd-study-feature-card">
                      ...
                      <p>
                        Join scheduled study sessions and collaborate with other
                        students
                      </p>
                    </div>
                    ...
                    <div className="sd-study-feature-card">
                      ...
                      <p>
                        Get materials tailored to your current academic year and
                        semester
                      </p>
                    </div>
                  </div>
