...
import com.campusconnect.presidentdashboard.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterPresidentRequest request) {
