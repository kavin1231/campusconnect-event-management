            ...
            <div className="footer-grid">
                ...
                <div className="footer-brand">
                    <div className="footer-logo">
                        <img src="/logo/Nexora event logo design.png" alt="NEXORA" className="logo-image-footer" />
                        <span>NEXORA</span>
                    </div>
                    <p className="footer-tagline">Connecting students through amazing events</p>
    ...
    return (
        <div className="landing-container">
            ...
            <main className="main-content">
                ...
                <section className="hero-banner" style={{ backgroundImage: `url('${featuredEvent?.image || 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?auto=format&fit=crop&q=80&w=1600'}')` }}>
                    ...
                    <div className="hero-content">
                        <div className="hero-meta">
                            ...
                            <span className="hero-date">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                {featuredEvent ? new Date(featuredEvent.date).toLocaleDateString('en-US', { 
                                    month: 'short', 
                                    day: 'numeric', 
                                    year: 'numeric' 
                                }) : 'Loading...'}
                        ...
                        <h1 className="hero-title">
                            {featuredEvent ? featuredEvent.title : 'Annual University'} <span className="highlight-accent"><br />{featuredEvent?.category || '2024'}</span>
                        </h1>
                        <p className="hero-desc">
                            {featuredEvent?.description || 'Experience amazing events on campus'}
                        </p>
                        <div className="hero-actions">
                            <button 
                                className="btn-primary"
                                onClick={(e) => featuredEvent && handleRegisterEvent(e, featuredEvent.id)}
                                disabled={featuredEvent && registrationLoading[featuredEvent.id]}
                            >
                                {featuredEvent && registrationLoading[featuredEvent.id] ? 'Processing...' : 'Register Now'}
                                    ...
                                    >
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="card-footer">
                                                ...
                                                >
                                                    <span>
                                                        {registrationLoading[event.id] ? 'Processing...' : 'Register Now'}
                                                    </span>
