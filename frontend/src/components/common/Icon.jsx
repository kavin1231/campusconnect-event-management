...
export const Icon = {
  ...
  Events:       ({ size = 16 } = {}) => <Ic size={size}><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" /></Ic>,
  ...
  ArrowLeft:    ({ size = 16 } = {}) => <Ic size={size} sw="2"><path d="M19 12H5M12 5l-7 7 7 7" /></Ic>,
  CheckCircle:  ({ size = 16 } = {}) => <Ic size={size}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><path d="M22 4L12 14.01l-3-3" /></Ic>,
  Image:        ({ size = 20 } = {}) => <Ic size={size}><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.5" /><path d="M21 15l-5-5L5 21" /></Ic>,
  Ticket:       ({ size = 16 } = {}) => <Ic size={size}><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v2z" /></Ic>,
  Package:      ({ size = 16 } = {}) => <Ic size={size}><path d="M16.5 9.4l-9-5.19M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><path d="M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12" /></Ic>,
  BarChart:     ({ size = 16 } = {}) => <Ic size={size}><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /><line x1="2" y1="20" x2="22" y2="20" /></Ic>,
  Eye:          ({ size = 14 } = {}) => <Ic size={size}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></Ic>,
  ExternalLink: ({ size = 12 } = {}) => <Ic size={size}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></Ic>,
