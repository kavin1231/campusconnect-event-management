...
export default function PendingPage({ event, onBack }) {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", padding: "32px 36px", display: "flex", flexDirection: "column", gap: "24px" }}>
      <button onClick={onBack} style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "none", border: "none", cursor: "pointer", color: C.textMuted, fontSize: "13px", fontFamily: FONT, fontWeight: "600", padding: 0, transition: "color .15s", width: "fit-content" }} onMouseEnter={(e) => { e.currentTarget.style.color = C.primary; }} onMouseLeave={(e) => { e.currentTarget.style.color = C.textMuted; }}>
      ...
      <div style={{ background: C.warningLight, border: `1.5px solid ${C.warning}30`, borderRadius: "16px", padding: "24px 28px", display: "flex", alignItems: "flex-start", gap: "18px" }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "6px" }}>
            <h2 style={{ margin: 0, fontSize: "18px", fontWeight: "800", color: C.text, fontFamily: FONT }}>Approval Pending</h2>
            <StatusBadge status="pending" size="lg" />
          </div>
          <p style={{ margin: 0, fontSize: "13px", color: C.textMuted, fontFamily: FONT, lineHeight: 1.7 }}>This event is currently under review by the university administration. You will receive an email notification once a decision has been made. No changes can be made while the request is being reviewed.</p>
        </div>
      </div>
